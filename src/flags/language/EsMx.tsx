...
const SvgEsMx = (props: SvgProps) => (
  <Svg width={24} height={24} {...props}>
    ...
    <G mask="url(#es-mx_svg__a)">
      <Path fill="#ffda44" d="m0 128 192-32 192 32-256 256-64 32-64-32Z" />
      <Rect width={16} height={24} x={128} y={192} fill="#d80027" rx={8} />
      <Rect width={16} height={24} x={272} y={192} fill="#d80027" rx={8} />
